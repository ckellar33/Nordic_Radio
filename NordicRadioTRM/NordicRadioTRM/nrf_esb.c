...
static void start_tx_transaction()
{
    ...
    switch (m_config_local.protocol)
    {
        ...
        case NRF_ESB_PROTOCOL_ESB_DPL:
            ...
            {
//                NRF_RADIO->SHORTS   = RADIO_SHORTS_COMMON; // CSK Commented out 
	            NRF_RADIO->SHORTS = RADIO_SHORTS_END_DISABLE_Msk | RADIO_SHORTS_READY_START_Msk | RADIO_SHORTS_END_START_Msk;
